...
var _View_MessagesComponent0 = (function (_super) {
    ...
    _View_MessagesComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_2 = this.renderer.createElement(this._el_0, 'app-message-input', null);
        this._appEl_2 = new import2.AppElement(2, 0, this, this._el_2);
        var compView_2 = import12.viewFactory_MessageInputComponent0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        compView_2.create(this._MessageInputComponent_2_4, [], null);
    ...
    _View_MessagesComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import10.MessageInputComponent) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._MessageInputComponent_2_4;
        }
        if (((token === import11.MessageListComponent) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 11)))) {
    ...
    _View_MessagesComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._MessageInputComponent_2_4.ngOnInit();
        }
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
...
export function viewFactory_MessagesComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessagesComponent === null)) {
        (renderType_MessagesComponent = viewUtils.createRenderComponentType('C:/Users/guptam00/Desktop/Udemy/node max course 1 nov 2016/01 Seed/assets/app/messages/messages.component.ts class MessagesComponent - inline template', 0, import8.ViewEncapsulation.None, styles_MessagesComponent, {}));
    }
