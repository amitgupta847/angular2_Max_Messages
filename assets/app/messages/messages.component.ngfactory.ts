...
class _View_MessagesComponent0 extends import1.AppView<import3.MessagesComponent> {
  ...
  _MessageInputComponent_2_4:import10.MessageInputComponent;
  _text_3:any;
  _text_4:any;
  _text_5:any;
  _el_6:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_2 = this.renderer.createElement(this._el_0,'app-message-input',(null as any));
    this._appEl_2 = new import2.AppElement(2,0,this,this._el_2);
    var compView_2:any = import12.viewFactory_MessageInputComponent0(this.viewUtils,this.injector(2),this._appEl_2);
    this._MessageInputComponent_2_4 = new import10.MessageInputComponent(this.parentInjector.get(import13.MessageService));
    this._appEl_2.initComponent(this._MessageInputComponent_2_4,[],compView_2);
    this._text_3 = this.renderer.createText((null as any),' ',(null as any));
    compView_2.create(this._MessageInputComponent_2_4,[],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import10.MessageInputComponent) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._MessageInputComponent_2_4; }
    if (((token === import11.MessageListComponent) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._MessageListComponent_10_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._MessageInputComponent_2_4.ngOnInit(); }
...
export function viewFactory_MessagesComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessagesComponent> {
  if ((renderType_MessagesComponent === (null as any))) { (renderType_MessagesComponent = viewUtils.createRenderComponentType('C:/Users/guptam00/Desktop/Udemy/node max course 1 nov 2016/01 Seed/assets/app/messages/messages.component.ts class MessagesComponent - inline template',0,import8.ViewEncapsulation.None,styles_MessagesComponent,{})); }
